...
import codewars.kata.PokerHand;
...
public class PokerHandRankingTest {
     ...
     PokerHand.Result loss = PokerHand.Result.LOSS;
     PokerHand.Result win = PokerHand.Result.WIN;
    PokerHand.Result tie = PokerHand.Result.TIE;
